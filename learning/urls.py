...
urlpatterns = [
    ...
    path("manage/lessons/reuse/", views.reuse_lesson, name="reuse_lesson"),
    ...
    path("manage/assignments/<int:pk>/", views.assignment_submissions, name="assignment_submissions"),
    path("manage/lessons/<int:pk>/results/", views.lesson_results, name="lesson_results"),
    ...
    path("manage/quizzes/<int:pk>/edit/", views.edit_quiz, name="edit_quiz"),
